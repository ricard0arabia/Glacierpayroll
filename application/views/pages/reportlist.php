...
<div class="nav-tabs-custom">
                ...
                <li style = "font-weight: bold;"class = "active"><a href="#" role ="tab">Reports Table</a></li>
...
<div class="row">
    <div class="col-lg-12">
           ...
           <div class = "panel-heading"><h5>Pay Period List -  Manage Report</h5></div> 
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php $j=0;
                            ...
                            <tr class="<?php echo $style; ?> gradeX">
                                ...
                                <td class="center"><a class="waves-effect waves-light btn" href="<?php echo site_url()."report/sss/".$_payperiod['id']; ?>">View</a> | <a class="waves-effect waves-light btn" href="<?php echo site_url()."report/delete/".$_payperiod['id']; ?>" onClick="return confirm('Are you sure you want to remove this record?')">Delete</a></td>
                                <?php } else { ?>
                                <td class="center"><a class="waves-effect waves-light btn" href="<?php echo site_url()."report/view/".$_payperiod['id']; ?>">View</a></td>
                                <?php } ?>
                            </tr>
                            <?php }} ?>
