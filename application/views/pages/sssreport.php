<div class="nav-tabs-custom">
                ...
                <li class = "active"><a href="#" role ="tab">SSS Reports</a></li>
...
<div class="row">
    <div class="col-lg-12">
         ...
         <div class = "panel-heading"><h5>Manage SSS Summary Report</h5></div> 
                <div class="divider"></div>
                <br><br>
            <a class="waves-effect waves-light btn" href="<?php echo site_url()."report/sss/".$this->uri->segment(3)."/print" ?>">Print</a> 
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php $j=0;
                            ...
                            <tr class="<?php echo $style; ?> gradeX">
                                ...
                                <td><?php echo $_employees['sss_no'] ?></td>
