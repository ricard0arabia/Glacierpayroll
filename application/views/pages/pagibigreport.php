<div class="nav-tabs-custom">
                ...
                <li><a href="<?php echo site_url()."report/sss/".$this->uri->segment(3) ?>" role ="tab">SSS Reports</a></li>
                 <li ><a href="<?php echo site_url()."report/phic/".$this->uri->segment(3) ?>" role ="tab">PHIC Report</a></li>
                  <li class = "active"><a href="<?php echo site_url()."report/pagibig/".$this->uri->segment(3) ?>" role ="tab">Pag-Ibig Report</a></li>
...
<div class="row">
    <div class="col-lg-12">
         ...
         <div class = "panel-heading"><h5>Manage Pag-Ibig Summary Report</h5></div> 
                <div class="divider"></div>
                <br><br>
                <a class="waves-effect waves-light btn" href="<?php echo site_url()."report/pagibig/".$this->uri->segment(3)."/print" ?>">Print</a> 
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <?php $j=0;
                            ...
                            <tr class="<?php echo $style; ?> gradeX">
                                ...
                                <td><?php echo $_employees['hdmf_no'] ?></td>
